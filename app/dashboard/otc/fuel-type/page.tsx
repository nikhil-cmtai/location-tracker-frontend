...
import { fetchAllFuelTypes } from '@/lib/redux/features/fuelTypeSlice';

interface FuelTypeDisplay {
  _id: string;
  fuelTypeName: string;
...
// Headers for export
const headers: { key: keyof FuelTypeDisplay; label: string }[] = [
  { key: 'fuelTypeName', label: 'Fuel Type Name' },
  { key: 'fuelTypeDescription', label: 'Description' },
];
...
export default function FuelTypePage() {
  ...
  const displayFuelTypes: FuelTypeDisplay[] = fuelTypes.map((fuelType) => ({
    _id: fuelType._id,
    fuelTypeName: fuelType.fuelTypeName,
    fuelTypeDescription: fuelType.fuelTypeDescription,
  }));

  const filteredFuelTypes = displayFuelTypes.filter((fuelType) =>
    Object.values(fuelType).some((value) =>
  ...
  const currentFuelTypes = filteredFuelTypes.slice(startIndex, endIndex);
      ...
      <div className="bg-white rounded-lg shadow-sm border border-[var(--border-light)] mb-6">
        <div className="p-4 flex items-center justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            {/* Export Buttons */}
            <div className="flex items-center gap-2">
              <ExportButtons data={displayFuelTypes} headers={headers} filename="fuel_types" allData={displayFuelTypes} />
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 flex-1 justify-end flex-wrap">
            ...
            {/* Add New Button */}
            <Link
              href="/dashboard/otc/fuel-type/add"
      ...
      <div className="bg-white rounded-lg shadow-sm border border-[var(--border-light)] overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="divide-y divide-[var(--border-light)]">
              ...
              ) : currentFuelTypes.length > 0 ? (
                currentFuelTypes.map((fuelType, index) => (
                  <tr key={fuelType._id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm">
                      <Link
                        href={`/dashboard/otc/fuel-type/${fuelType._id}`}
        ...
        <div className="px-6 py-4 border-t border-[var(--border-light)] flex items-center justify-between flex-wrap gap-4">
          <div className="text-sm text-[var(--text-secondary)]">
            Showing results {startIndex + 1} out of {filteredFuelTypes.length}
          </div>
          <div className="flex items-center gap-2">
            <button
