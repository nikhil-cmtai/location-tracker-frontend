...
interface VehicleOwnerFormProps {
  initialData?: VehicleOwnerFormData;
  onSubmit: (data: VehicleOwnerFormData) => void;
  onCancel: () => void;
  isEditMode?: boolean;
}
    ...
    <div className="p-6 bg-[var(--content-bg)]">
      <div className="bg-white rounded-lg shadow-sm border border-[var(--border-light)] p-6">
        <h1 className="text-2xl font-bold text-[var(--primary-orange)] mb-6">
          {isEditMode ? 'Edit Vehicle Owner Type' : 'Add New Vehicle Owner Type'}
        </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                required
                name="ownerType"
                placeholder="Enter Owner Type (e.g., Owned, Leased, Rented)"
