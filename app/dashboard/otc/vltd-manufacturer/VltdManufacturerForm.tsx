...
export interface VltdManufacturerFormData {
  manufacturerName: string;
  shortName: string;
}

interface VltdManufacturerFormProps {
  initialData?: VltdManufacturerFormData;
  onSubmit: (data: VltdManufacturerFormData) => void;
  onCancel: () => void;
  title: string;
  submitButtonText: string;
}

const defaultFormData: VltdManufacturerFormData = {
  manufacturerName: '',
  shortName: '',
};

export default function VltdManufacturerForm({
  initialData,
  onSubmit,
  onCancel,
  title,
  submitButtonText,
}: VltdManufacturerFormProps) {
  const [formData, setFormData] = useState<VltdManufacturerFormData>(
